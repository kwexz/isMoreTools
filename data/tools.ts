...
export const tools: Tool[] = [
  ...
  { slug: "clean-extra-spaces", title: "Clean Extra Spaces", description: "Trim lines, collapse spaces, and normalize line endings.", category: "Text Tools", icon: "Eraser", tags: ["text", "spaces"], featured: false, status: "implemented" },
  ...
  { slug: "transliteration", title: "Transliteration", description: "Convert Cyrillic text to Latin characters.", category: "Text Tools", icon: "Languages", tags: ["cyrillic", "latin", "slug"], featured: false, status: "implemented" },
  ...
  { slug: "lorem-ipsum", title: "Lorem Ipsum Generator", description: "Generate words, sentences, or paragraphs of placeholder copy.", category: "Text Tools", icon: "Pilcrow", tags: ["lorem", "placeholder"], featured: false, status: "implemented" },
  ...
  { slug: "batch-rename-preview", title: "Batch Rename Preview", description: "Preview file rename patterns and export CSV.", category: "File Tools", icon: "ListTree", tags: ["rename", "files"], featured: false, status: "implemented" },
  { slug: "generate-checksum-file", title: "Generate Checksum File", description: "Create a checksums.sha256.txt file for selected files.", category: "File Tools", icon: "FileArchive", tags: ["sha256", "checksum"], featured: false, status: "implemented" },
  ...
  { slug: "compress-images", title: "Compress PNG/JPEG/WebP", description: "Compress browser-supported images and compare sizes.", category: "Image Tools", icon: "Archive", tags: ["image", "compress"], featured: false, status: "implemented" },
  ...
  { slug: "png-to-svg", title: "PNG to SVG Converter", description: "Wrap PNGs in SVG or create a simple pixel-vector mosaic.", category: "Image Tools", icon: "FileImage", tags: ["png", "svg", "convert"], featured: true, status: "implemented" },
  { slug: "crop-image", title: "Crop Image", description: "Crop images with aspect presets and export the result.", category: "Image Tools", icon: "Crop", tags: ["image", "crop"], featured: false, status: "implemented" },
  { slug: "remove-image-metadata", title: "Remove Image Metadata", description: "Read EXIF when available and re-encode a cleaned image.", category: "Image Tools", icon: "BadgeX", tags: ["exif", "metadata"], featured: false, status: "implemented" },
  { slug: "favicon-generator", title: "Generate Favicon Set", description: "Generate common favicon PNG sizes and HTML tags.", category: "Image Tools", icon: "Sparkles", tags: ["favicon", "icons"], featured: false, status: "implemented" },
  { slug: "extract-color-palette", title: "Extract Color Palette", description: "Sample dominant colors from an uploaded image.", category: "Image Tools", icon: "Palette", tags: ["color", "palette"], featured: false, status: "implemented" },
